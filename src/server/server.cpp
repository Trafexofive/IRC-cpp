...
void CoreServer::create_socket()
{
   std::cout << formatServerMessage("DEBUG", "Creating socket...") << std::endl;
    ...
    std::cout << formatServerMessage("DEBUG", "Socket setup complete") << std::endl;
}
...
void CoreServer::start_listening()
{
    ...
    std::cout << formatServerMessage("DEBUG", "Starting to listen...") << std::endl;
...
{
    std::cout << formatServerMessage("DEBUG", "Initializing server...") << std::endl;
    ...
    {
        std::cerr << formatServerMessage("ERROR", "Invalid password requirements:") << std::endl;
    ...
    std::cout << formatServerMessage("DEBUG", "Registering commands...") << std::endl;
